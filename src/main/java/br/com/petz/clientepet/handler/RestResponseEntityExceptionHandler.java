...
public class RestResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorApiResponse> handlerGernericException(APIException ex) {
		return ex.buildErrorResponseEntity();
	}

	@ExceptionHandler(Exception.class)
	public ResponseEntity<ErrorApiResponse> handlerGernericException(Exception ex) {
